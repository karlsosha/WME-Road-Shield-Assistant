...
<b>KNOWN ISSUES:</b><br>
    ...
    const RoadAbbr: CountryRoadInfo = {
        ...
        40: {
            ...
            Ontario: {
                ...
                "^Regional (Road|Rd) [1-9][0-9]{0,2}\\b": new Set<number>([5065, 5063, 5077]), // Ontario Regional
            },
            Quebec: {
        ...
        235: {
            ...
            Georgia: {
                "^CR-[1-9][0-9]{0,2}\\b": 2002,
                "^SH-[1-9][0-9]{0,2}\\b": 2036,
                "^SR-[1-9][0-9]{0,2}\\b": 2036,
            },
            Hawaii: {
                "H-[1-9][0-9]{0,2}": 5,
                "CR-[1-9][0-9]{0,2}": 2002,
            ...
            Ohio: {
                "^CH-[1-9][0-9]{0,2}\\b": 2002,
                "^CR-[1-9][0-9]{0,3}\\b": 2181,
                "^SH-[1-9][0-9]{0,2}\\b": 2095,
                "^SR-[1-9][0-9]{0,2}\\b": 2095,
            },
            Oklahoma: {
                "^SH-[1-9][0-9]{0,2}\\b": 2097,
                "^SR-[1-9][0-9]{0,2}\\b": 2097,
            },
            Oregon: {
                "^CH-[1-9]\\d{0,2}\\b": 2002,
                "^CR-[1-9]\\d{0,2}\\b": 2002,
    ...
    function checkOptions() {
        ...
        if (countries.length < 1) {
            ...
            let textSegShieldMissing: JQuery<HTMLElement> = $("#rsa-text-SegShieldMissing");
            let textSegShieldError: JQuery<HTMLElement> = $("#rsa-text-SegShieldError");
            let textNodeShieldMissing: JQuery<HTMLElement> = $("#rsa-text-NodeShieldMissing");
            if (!allowFeat) {
        ...
        $.each(segment.geometry.coordinates, function (idx, param) {
            ...
            if (oldparam.x && oldparam.y && oldparam.x !== null && oldparam.y !== null) {
                if (
                    ...
                    if (
                        (centerparam.x && Math.abs(centerparam.x - param[0]) > labelDis.space) ||
    ...
    function createHighlight(obj: Segment | Node, color: string, overSized: boolean = false) {
