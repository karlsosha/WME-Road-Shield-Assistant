...
<b>KNOWN ISSUES:</b><br>
    ...
    function displaySegShields(
        ...
        // let SegmentPoints = [];
        let oldparam: Coordinates = { x: null, y: null };
        ...
        $.each(segment.geometry.coordinates, function (idx: number, param: Position) {
            ...
            if (oldparam.x && oldparam.y && oldparam.x !== null && oldparam.y !== null) {
                if (
                    ...
                    let centerparam: Coordinates = { x: undefined, y: undefined };
    ...
    function createHighlight(obj: Segment | Node, color: string, overSized: boolean = false) {
        ...
        if (isNode) {
            ...
            let pointNode: GeoJSON.Point = { type: "Point", coordinates: (geo as Point).coordinates };
